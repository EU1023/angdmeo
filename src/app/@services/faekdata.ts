...
export class FaekData{
  ...
  ELEMENT_DATA:PeriodicElement[] = [
    {id: 1, name: 'Hydrogen', html:'http://localhost:4200/moguhyo1/siyousya2', state: '進行中', start_time: '2024/11/01', end_time:'2024/11/30', GoTo:'http://localhost:4200/moguhyo1/siyousya4'},
